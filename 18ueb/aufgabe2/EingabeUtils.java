...
public class EingabeUtils {
	...
	public static String scanString(Scanner scanner){
		...
		try {
			userInput = scanner.next();
            		...
            		scanner.nextLine();
			throw new MyIllegalArgumentException("Input has to be a String");
		}
		return userInput;
	}
	 ...
	 */
    	public static int scanInt(Scanner scanner){
        	...
        	try {
            		...
            		scanner.nextLine();
            		throw new MyIllegalArgumentException("Input has to be an Integer");
        	}
        	return userInput;
    	}
	 ...
	 */
		...
		try{
		    	...
		    	scanner.nextLine();
		    	throw new MyIllegalArgumentException("Input has to be a Long");
		}
		return userInput;
    	}
	 ...
	 */
    	public static double scanDouble(Scanner scanner){
        	...
        	try{
            		...
            		scanner.nextLine();
            		throw new MyIllegalArgumentException("Input has to be a Double");
        	}
        	return userInput;
    	}
	 ...
	 */
		...
		try{
		    	...
		    	scanner.nextLine();
		    	throw new MyIllegalArgumentException("Input has to be a Short");
		}    
		return userInput;
	}
	 ...
	 */
		...
		try{
			userInput = scanner.nextFloat();
		    	...
		    	scanner.nextLine();
		    	throw new MyIllegalArgumentException("Input has to be a Float");
		}
		return userInput;
	}
	 ...
	 */
    	public static boolean scanBoolean(Scanner scanner){
        	...
        	try{
            		...
            		scanner.nextLine();
            		throw new MyIllegalArgumentException("Input has to be a Boolean");
        	}
        	return userInput;
    	}
