...
public class Tester{
    ...
    public void run() {
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println("Test the Methode applyAndPrint with the Methode anonymFactoriel");
        function.applyAndPrint(num1, num2, function.getAnonymFactoriel());
        System.out.println("------------------------------------------------------------------");
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println("Test the Methode applyAndPrint with the Methode anonymFibonacci");
        function.applyAndPrint(num1, num2, function.getAnonymFibonacci());
        System.out.println("------------------------------------------------------------------");
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println("Test the Methode applyAndPrint with the Methode anonymQuadratic");
        function.applyAndPrint(num1, num2, function.getAnonymQuadratic());
        System.out.println("------------------------------------------------------------------");
