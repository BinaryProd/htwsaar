...
public class EingabeUtils {
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * String else it will give an error
     * 
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a Int
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * long else it will give an error
     * 
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * double else it will give an error
     * 
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * short else it will give an error
     * 
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * float else it will give an error
     * 
    ...
    /**
     * This methode is used to scann the value of the input and check if it is a
     * boolean else it will give an error
     * 
