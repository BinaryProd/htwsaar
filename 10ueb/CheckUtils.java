public class CheckUtils {
    ...
    public static void checkObjectNull(Object object) {
        if (object == null) {
            throw new IllegalArgumentException("Das Objekt ist null.");
        }
    }

    public static void checkIfPerson(Object object) {
        if (!(object instanceof Person)) {
            throw new IllegalArgumentException("Das Objekt ist keine Person.");
        }
    }

    public static void checkIfString(Object object) {
        if (!(object instanceof String)) {
            throw new IllegalArgumentException("Das Objekt ist kein String.");
        }
    }
    ...
    public static void checkIndex(int index, int capacity) {
        if (index < 0 || index > capacity) {
            throw new IllegalArgumentException("Der Index ist nicht gültig.");
        }
    }
